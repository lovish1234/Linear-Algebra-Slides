...
{ % is placed on the title page
      \textbf{Improvement of Xuming method for elder}
}

\subtitle[Improvement of Xuming method for elder]
{
      \textbf{Jiang Zeming}
}
...
\begin{frame}{Introduction}{License2}
\transduration{0.75}
%-------------------------------------------------------

  \begin{itemize}
    \item<1-> The logo and color designed of ShanghaiTech university are owned by ShanghaiTech University.
  \end{itemize}
\end{frame}
